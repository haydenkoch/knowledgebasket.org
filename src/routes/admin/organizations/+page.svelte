...
<div class="space-y-6">
	...
	<form onsubmit={(e) => { e.preventDefault(); doSearch(); }} class="flex gap-2">
		<Input type="text" bind:value={searchValue} placeholder="Search organizations..." class="max-w-sm" />
				...
				<form method="POST" action="?/createOrganization" use:enhance class="space-y-4">
					<div class="grid gap-4 sm:grid-cols-2">
						...
						<div class="space-y-2">
							...
							<Input id="org-type" name="orgType" type="text" placeholder="e.g. nonprofit, tribal" />
						</div>
					</div>
					<div class="space-y-2">
